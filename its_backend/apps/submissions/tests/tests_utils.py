...
class SubmissionUtilsTest(TestCase):
    ...
    def test_process_submission_2_some_testcases_failed(self):
        ...
        expected_output = {
            ...
            "total_score": 4,
            "score": 2,
            "its_feedback_hint_student": '{"hints": [{"lineNumber": 2, "hintStrings": ["Incorrect else block for if( ((x % 2) == 0) )"]}]}',
            "its_feedback_fix_tutor": '{"fixes": [{"lineNumber": 2, "oldExpr": "{return False; }", "newExpr": "{ return True; }", "repairStrings": ["You need to change the condition/body of if-conditions", "Change the else-body of if(((x % 2) == 0)) to { return True; }"]}]}',
            "status": "ITS SUCCESS",
        }
        self.assertEqual(result, expected_output)
    ...
    def test_process_submission_3_all_testcases_failed(self):
        ...
        expected_output = {
            ...
            "total_score": 4,
            "score": 0,
            "its_feedback_hint_student": '{"hints": [{"lineNumber": 1, "hintStrings": ["You need to add 1 or more if-conditions", "Consider conditions if (((x % 2) == 0))"]}]}',
            "its_feedback_fix_tutor": '{"fixes": [{"lineNumber": 1, "oldExpr": "", "newExpr": "(((x % 2) == 0)) { return False; } else { return True; }", "repairStrings": ["You need to add 1 or more if-conditions", "Add if (((x % 2) == 0)) { return False; } else { return True; }"]}]}',
            "status": "ITS SUCCESS",
        }
        self.assertEqual(result, expected_output)
    ...
    def test_process_submission_4_its_parser_generates_empty_result(self):
        ...
        expected_output = {
            ...
            "its_feedback_hint_student": '{"hints": []}',
            "its_feedback_fix_tutor": '{"fixes": []}',
            "status": "The ITS parser generates empty parsed result for the Student Submission Program. ",
        }
        self.assertEqual(result, expected_output)
    ...
    def test_process_submission_5_its_failed_in_parsing_student_program(self):
        ...
        expected_output = {
            ...
            "its_feedback_hint_student": '{"hints": []}',
            "its_feedback_fix_tutor": '{"fixes": []}',
            "status": "The ITS failed to parse Student Program and raises 500 Internal Error. ",
        }
        self.assertEqual(result, expected_output)
    ...
    def test_process_submission_6_its_failed_in_parsing_reference_program(self):
        ...
        expected_output = {
            ...
            "its_feedback_hint_student": '{"hints": []}',
            "its_feedback_fix_tutor": '{"fixes": []}',
            "status": "The ITS failed to parse Reference Program and raises 500 Internal Error. ",
        }
        self.assertEqual(result, expected_output)
    ...
    def test_process_submission_7_its_failed_in_interpreter(self):
        ...
        expected_output = {
            ...
            "its_feedback_hint_student": '{"hints": []}',
            "its_feedback_fix_tutor": '{"fixes": []}',
            "status": "The ITS interpreter fails to interprete the Program and Testcases. The ITS fails to provide Feedback Fix. The ITS fails to provide Feedback Hint. ",
        }
        self.assertEqual(result, expected_output)
    ...
    def test_process_submission_8_its_failed_in_feedback_generation(self):
        ...
        expected_output = {
            ...
            "its_feedback_hint_student": '{"hints": []}',
            "its_feedback_fix_tutor": '{"fixes": []}',
            "status": "The ITS fails to provide Feedback Fix. The ITS fails to provide Feedback Hint. ",
        }
        self.assertEqual(result, expected_output)
